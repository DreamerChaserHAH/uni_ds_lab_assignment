...
void test_selection_sort_with_array_2() {
...
int main() {
    test_selection_sort_with_array_1();
    test_selection_sort_with_array_2();
    return 0;
}