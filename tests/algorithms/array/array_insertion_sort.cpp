...
void test_insertion_sort_with_array_2() {
...
int main() {
    test_insertion_sort_with_array_1();
    test_insertion_sort_with_array_2();
    return 0;
}