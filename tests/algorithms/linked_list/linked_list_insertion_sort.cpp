...
void test_insertion_sort_with_linked_list_2() {
...
int main() {
    test_insertion_sort_with_linked_list_1();
    test_insertion_sort_with_linked_list_2();
    return 0;
}